...
public class ExplosiveArrowEntity /*extends ProjectileItemEntity*/ {
    ...
    protected void func_225516_i_() {
        ++this.ticksOnEntity;
        if (this.ticksOnEntity >= 40) { //TODO CHANGE VALUE AFTER DEBUGGING, DEFAULT ARROW 1200
            if (!this.onGround) {
                LogManager.getLogger().info("ON GROUND");
            }
            else {
                LogManager.getLogger().info("ON SOMEONE");
            }
